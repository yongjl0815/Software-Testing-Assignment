...
int newsmithy(int currentPlayer , struct gameState *state, int handPos, int i)
{
	for (i = 0; i < 3; i++)
	{
...
int newAD(int drawntreasure, struct gameState *state, int currentPlayer, int cardDrawn, int temphand[], int z)
{
...
int newSeahag(int currentPlayer, struct gameState *state, int i){
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  if ( card == smithy){
      //+3 Cards
	  return (newsmithy(currentPlayer, state, handPos, i));
  }
  
   else if (card == adventurer){
	  return (newAD(drawntreasure, state, currentPlayer, cardDrawn, temphand, z));
  }
		...
		return (newSeahag(currentPlayer, state, i));
	}
